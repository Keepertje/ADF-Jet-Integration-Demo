...
(function() {
    ...
    var lib$es6$promise$asap$$browserWindow = typeof window !== 'undefined'
        ? window
        : undefined;
    ...
    var lib$es6$promise$asap$$isWorker = typeof Uint8ClampedArray !==
        'undefined' &&
    ...
    function lib$es6$promise$asap$$attemptVertx() {
        try {
            var r = require;
            var vertx = r('vertx');
            lib$es6$promise$asap$$vertxNext = vertx.runOnLoop ||
                vertx.runOnContext;
    ...
    var lib$es6$promise$$internal$$PROMISE_ID = Math
        .random()
        .toString(36)
        .substring(16);
    ...
    function lib$es6$promise$$internal$$subscribe(
        ...
        subscribers[length +
            lib$es6$promise$$internal$$FULFILLED] = onFulfillment;
